...
public class BabyIdleState : IState
{
    ...
    public const float STATE_SPEED = 10;
    public Color STATE_COLOR = Color.yellow;

    PerimeterController perimeterController;

    public BabyIdleState(StateMachine owner, SteeringBehavior steering, PerimeterController perimeterController)
    {
        this.owner = owner;
